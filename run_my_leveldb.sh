...
./ycsb -load -db leveldb -P workloads/workload_getkeys -P leveldb/leveldb.properties -s

# Step 4: Run the workload
./ycsb -run -db leveldb -P workloads/workload_getkeys -P leveldb/leveldb.properties -s
